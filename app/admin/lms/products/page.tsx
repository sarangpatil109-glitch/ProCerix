...
export default async function LmsProductsPage() {
  ...
  const [
    ...
    db.from("courses")
      .select("id, title, slug, course_type, is_published, lms_status, price, original_price, category, difficulty, created_at, updated_at, thumbnail_url, is_featured, is_trending")
      .is("deleted_at", null)
